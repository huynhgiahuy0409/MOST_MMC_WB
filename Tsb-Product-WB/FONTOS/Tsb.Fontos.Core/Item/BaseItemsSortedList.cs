...
namespace Tsb.Fontos.Core.Item
{
    ...
    /// </summary>
    [Serializable]
    public class BaseItemsSortedList<T> : ITsbBaseObject, IEnumerable<T> where T : IDataItem
    {
        #region FIELD AREA ***************************************
        /// <summary>
        /// Object ID
        ...
        /// </summary>
        private SortedList<string, T> _sourceDic = null;
        #endregion
        ...
        protected SortedList<string, T> Source
        {
        ...
        public BaseItemsSortedList(IList<T> list)
            //: this(list, true)
        {
            _objectID = "GNR-FTCO-ITM-BaseItemsDictionary";
            _sourceDic = MakeSortedListData(list);
        }
        ///// <summary>
        ///// Initializes a new instance of item list using a specified IList(Of T) implementation list.
        ///// Initially, all element item of list are set as property changed event enabled.
        ...
        //public BaseItemsSortedList(IList<T> list, bool isBackupRequired)
        //{
        //    _objectID = "GNR-FTCO-ITM-BaseItemsDictionary";
        //    _sourceDic = MakeSortedListData(list);
        //}
        /// <summary>
        /// Make SortedList data
        /// </summary>
        /// <param name="list"IList(Of T) implementation list></param>
        private SortedList<string, T> MakeSortedListData(IList<T> list)
        {
            SortedList<string, T> dic = new SortedList<string, T>();
            if (list != null)
            {
