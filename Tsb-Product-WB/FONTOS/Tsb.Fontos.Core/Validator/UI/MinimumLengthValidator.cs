...
{
    public class MinimumLengthValidator : BasePasswordValidator
    {
        #region READONLY AREA **********************************
        /// <summary>
        /// Password Regx
        /// </summary>
        private readonly string PASSWORD_REGX = @"(?=^.{" + SecurityPolicyInfo.GetInstance().MinimumLength + ",}$)";
        #endregion
        ...
        public SecurityPolicyInfo.PasswordValidationResultTypes ValidatorType 
        {
            get
            {
                return SecurityPolicyInfo.PasswordValidationResultTypes.MINIMUM;
            } 
        }
        #endregion
        ...
        public MinimumLengthValidator()
            : base()
        {
            this.ObjectID = "GNR-FTCO-VAL-MinLengthValidator";
        ...
        /// <summary>
        /// Validates whether minimum length
        /// </summary>
        ...
        public override List<ValidResultItem> Validate(ref List<ValidResultItem> resultList)
        {
            ...
            {
                //MSG:Password should be more than {0}-digits.
                resultList = this.HandleResult(ref resultList, ResultType.ERROR, "MSG_FTCO_00186", DefaultMessage.NON_REG_WRD + SecurityPolicyInfo.GetInstance().MinimumLength);
            }
            else
            {
