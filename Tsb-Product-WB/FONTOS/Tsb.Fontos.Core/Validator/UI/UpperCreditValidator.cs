...
{
    public class UpperCreditValidator : BasePasswordValidator
    {
        #region READONLY AREA **********************************
        /// <summary>
        /// Password Regx
        /// </summary>
        private readonly string PASSWORD_REGX = @"(?=(?:.*?[A-Z]){" + SecurityPolicyInfo.GetInstance().UpperCredit + "})";
        #endregion
        ...
        public SecurityPolicyInfo.PasswordValidationResultTypes ValidatorType 
        {
            get
            {
                return SecurityPolicyInfo.PasswordValidationResultTypes.UPPER;
            } 
        }
        #endregion
        ...
        /// Default Constructor
        /// </summary>
        public UpperCreditValidator()
            : base()
        {
            this.ObjectID = "GNR-FTCO-VAL-UpperCreditValidator";
        ...
        /// <summary>
        /// Validates whether Capital letters
        /// </summary>
        ...
        public override List<ValidResultItem> Validate(ref List<ValidResultItem> resultList)
        {
            ...
            {
                //MSG:Capital letters (A - Z) should be more than {0}.
                resultList = this.HandleResult(ref resultList, ResultType.ERROR, "MSG_FTCO_00187", DefaultMessage.NON_REG_WRD + SecurityPolicyInfo.GetInstance().UpperCredit);
            }
            else
            {
