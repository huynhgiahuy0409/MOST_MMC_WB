...
* 2012.09.25    Jindols 1.0	First release.
*
*/
#endregion
using System;
...
{
    /// <summary>
    /// OracleDoubleTypeHandlerCallback
    /// </summary>
    public class OracleDoubleTypeHandlerCallback : ITypeHandlerCallback
    {
        #region FIELD AREA *************************************
        #endregion
        ...
        /// Default Constructor
        /// </summary>
        public OracleDoubleTypeHandlerCallback()
        {
            this.ObjectID = "GNR-FTCO-DATTP-TsbDoubleTypeHandler";
        }
        #endregion
        ...
        public object ValueOf(string nullValue)
        {
            try
            {
                return Convert.ToDouble(nullValue);
            }
            catch (Exception)
            {
