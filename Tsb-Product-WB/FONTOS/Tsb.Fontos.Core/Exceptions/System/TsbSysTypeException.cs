...
{
    /// <summary>
    /// TSB System Type Exception
    /// </summary>
    [Serializable]
    public class TsbSysTypeException : TsbSysBaseException
    {
        private readonly string _OBJECT_ID = "GNR-FTCO-EXP-TsbSysTypeException";

        /// <summary>
        /// Default Constructor
        /// </summary>
        public TsbSysTypeException()
            : base()
        {
        ...
        public TsbSysTypeException(string objectID, string msgCode, params string[] msgArgs)
        ...
        /// <param name="msgCode">A message code to make message</param>
        /// <param name="msgArgs">An array of string to make message</param>
        public TsbSysTypeException(Exception innerException, string sourceObjectID, string msgCode, params string[] msgArgs)
