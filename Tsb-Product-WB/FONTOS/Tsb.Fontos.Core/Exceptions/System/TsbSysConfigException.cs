...
{
    /// <summary>
    /// TSB System Configuration Exception
    /// </summary>
    [Serializable]
    public class TsbSysConfigException : TsbSysBaseException
    {
        private readonly string _OBJECT_ID = "GNR-FTCO-EXP-TsbSysConfigException";

        /// <summary>
        /// Default Constructor
        /// </summary>
        public TsbSysConfigException()
            : base()
        {
        ...
        public TsbSysConfigException(string objectID, string msgCode, params string[] msgArgs)
        ...
        /// <param name="msgCode">A message code to make message</param>
        /// <param name="msgArgs">An array of string to make message</param>
        public TsbSysConfigException(Exception innerException, string sourceObjectID, string msgCode, params string[] msgArgs)
