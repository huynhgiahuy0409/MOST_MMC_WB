...
{
    /// <summary>
    /// TSB System Exception Base Class
    /// </summary>
    [Serializable]
    public class TsbSysBaseException : TsbBaseException
    {
        private readonly string _OBJECT_ID = "GNR-FTCO-EXP-TsbSysBaseException";

        /// <summary>
        /// Default Constructor
        /// </summary>
        public TsbSysBaseException()
            : base()
        {
        ...
        public TsbSysBaseException(string objectID, string msgCode, params string[] msgArgs)
        ...
        /// <param name="msgCode">A message code to make message</param>
        /// <param name="msgArgs">An array of string to make message</param>
        public TsbSysBaseException(Exception innerException, string sourceObjectID, string msgCode, params string[] msgArgs)
