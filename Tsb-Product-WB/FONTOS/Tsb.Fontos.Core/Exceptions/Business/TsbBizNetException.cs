...
namespace Tsb.Fontos.Core.Exceptions.Business
{
    ...
    /// </summary>
    [Serializable]
    public class TsbBizNetException : TsbBizBaseException
    {
        private readonly string _OBJECT_ID = "GNR-FTCO-EXP-TsbBizNetException";

        /// <summary>
        /// Default Constructor
        /// </summary>
        public TsbBizNetException()
            : base()
        {
        ...
        public TsbBizNetException(string objectID, string msgCode, params string[] msgArgs)
        ...
        /// <param name="msgCode">A message code to make message</param>
        /// <param name="msgArgs">An array of string to make message</param>
        public TsbBizNetException(Exception innerException, string sourceObjectID, string msgCode, params string[] msgArgs)
