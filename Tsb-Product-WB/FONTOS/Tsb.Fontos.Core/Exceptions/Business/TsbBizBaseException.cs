...
{
    /// <summary>
    ///  TSB Business Exception Base Class
    /// </summary>
    [Serializable]
    public class TsbBizBaseException : TsbBaseException
    {
        private readonly string _OBJECT_ID = "GNR-FTCO-EXP-TsbBizBaseException";

        /// <summary>
        /// Default Constructor
        /// </summary>
        public TsbBizBaseException()
            : base()
        {
        ...
        public TsbBizBaseException(string objectID, string msgCode, params string[] msgArgs)
        ...
        /// <param name="msgCode">A message code to make message</param>
        /// <param name="msgArgs">An array of string to make message</param>
        public TsbBizBaseException(Exception innerException, string sourceObjectID, string msgCode, params string[] msgArgs)
