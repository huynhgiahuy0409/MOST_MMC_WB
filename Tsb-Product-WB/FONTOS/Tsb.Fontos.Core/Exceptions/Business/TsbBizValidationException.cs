...
{
    /// <summary>
    /// TSB Business Validation Error Exception
    /// </summary>
    [Serializable]
    public class TsbBizValidationException : TsbBizBaseException
    {
        private readonly string _OBJECT_ID = "GNR-FTCO-EXP-TsbBizValidationException";


        /// <summary>
        /// Default Constructor
        /// </summary>
        public TsbBizValidationException()
            : base()
        {
        ...
        public TsbBizValidationException(string objectID, string msgCode, params string[] msgArgs)
        ...
        /// <param name="msgCode">A message code to make message</param>
        /// <param name="msgArgs">An array of string to make message</param>
        public TsbBizValidationException(Exception innerException, string sourceObjectID, string msgCode, params string[] msgArgs)
