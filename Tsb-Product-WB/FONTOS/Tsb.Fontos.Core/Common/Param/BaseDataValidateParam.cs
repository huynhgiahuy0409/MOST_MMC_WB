...
{
    public class BaseDataValidateParam : BaseParam
    {
        #region PROPERTY AREA ****************************
        public Enum RuleType { get; set; }
        public string[] PropertyNames { get; set; }
        public object TargetObject { get; set; }
        public string CheckValidatePropertyName { get; set; } // definitely recognize of validate property
        ...
        public BaseDataValidateParam()
            : base()
        {
            this.ObjectID = "PAR-FTCO-CMN-BaseDataValidateParam";
