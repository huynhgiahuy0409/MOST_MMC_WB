...
namespace Tsb.Fontos.Core.Exceptions.System
{
    ...
    /// </summary>
    [Serializable]
    public class TsbSysXmlException : TsbSysBaseException
    {
        private readonly string _OBJECT_ID = "GNR-FTCO-EXP-TsbSysXmlException";

         /// <summary>
        /// Default Constructor
        /// </summary>
        public TsbSysXmlException()
            : base()
        {
        ...
        public TsbSysXmlException(string objectID, string msgCode, params string[] msgArgs)
        ...
        /// <param name="msgCode">A message code to make message</param>
        /// <param name="msgArgs">An array of string to make message</param>
        public TsbSysXmlException(Exception innerException, string sourceObjectID, string msgCode, params string[] msgArgs)
