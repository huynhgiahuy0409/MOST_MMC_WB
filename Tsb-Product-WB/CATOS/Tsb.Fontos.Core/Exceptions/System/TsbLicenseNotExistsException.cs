...
namespace Tsb.Fontos.Core.Exceptions.System
{
    ...
    /// <summary>
    /// TSB License Not Exists Excetpion
    /// </summary>
    [Serializable]
    public class TsbLicenseNotExistsException : TsbSysBaseException
    {
        private readonly string _OBJECT_ID = "GNR-FTCO-EXP-TsbLicenseNotExistsException";

        /// <summary>
        /// Default Constructor
        /// </summary>
        public TsbLicenseNotExistsException()
            : base()
        {
        ...
        public TsbLicenseNotExistsException(string objectID, string msgCode, params string[] msgArgs)
        ...
        /// <param name="msgCode">A message code to make message</param>
        /// <param name="msgArgs">An array of string to make message</param>
        public TsbLicenseNotExistsException(Exception innerException, string sourceObjectID, string msgCode, params string[] msgArgs)
