...
* 2013.11.14  Jindols 1.0	First release.
*
*/
...
{
    /// <summary>
    /// System Busy Exception Class
    /// </summary>
    [Serializable]
    public class TsbSysBusyException : TsbSysBaseException
    {
        private readonly string _OBJECT_ID = "GNR-FTCO-EXP-TsbSysBusyException";

        /// <summary>
        /// Default Constructor
        /// </summary>
        public TsbSysBusyException()
            : base()
        {
        ...
        public TsbSysBusyException(string objectID, string msgCode, params string[] msgArgs)
        ...
        /// <param name="msgCode">A message code to make message</param>
        /// <param name="msgArgs">An array of string to make message</param>
        public TsbSysBusyException(Exception innerException, string sourceObjectID, string msgCode, params string[] msgArgs)
