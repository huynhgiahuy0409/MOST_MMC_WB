...
namespace Tsb.Fontos.Core.Exceptions.System
{
    ...
    /// <summary>
    /// TSB Security System Excetpion
    /// </summary>
    [Serializable]
    public class TsbSysSecurityException : TsbSysBaseException
    {
        private readonly string _OBJECT_ID = "GNR-FTCO-EXP-TsbSysSecurityExcetpion";

        /// <summary>
        /// Default Constructor
        /// </summary>
        public TsbSysSecurityException()
            : base()
        {
        ...
        public TsbSysSecurityException(string objectID, string msgCode, params string[] msgArgs)
        ...
        /// <param name="msgCode">A message code to make message</param>
        /// <param name="msgArgs">An array of string to make message</param>
        public TsbSysSecurityException(Exception innerException, string sourceObjectID, string msgCode, params string[] msgArgs)
