...
{
    /// <summary>
    /// TSB Business service layer Exception
    /// </summary>
    [Serializable]
    public class TsbBizServiceException : TsbBizBaseException
    {
        private readonly string _OBJECT_ID = "GNR-FTCO-EXP-TsbBizServiceException";


        /// <summary>
        /// Default Constructor
        /// </summary>
        public TsbBizServiceException()
            : base()
        {
        ...
        public TsbBizServiceException(string objectID, string msgCode, params string[] msgArgs)
        ...
        /// <param name="msgCode">A message code to make message</param>
        /// <param name="msgArgs">An array of string to make message</param>
        public TsbBizServiceException(Exception innerException, string sourceObjectID, string msgCode, params string[] msgArgs)
