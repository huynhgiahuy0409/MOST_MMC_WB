...
using Tsb.Fontos.Core.Data;
using Tsb.Fontos.Core.Exceptions.Formatter;

namespace Tsb.Fontos.Core.Exceptions.Business
{
    /// <summary>
    /// TSB DAO Layer Exception
    /// </summary>
    [Serializable]
    public class TsbBizDAOException : TsbBizBaseException
    {
        private readonly string _OBJECT_ID = "GNR-FTCO-EXP-TsbBizDAOException";


        /// <summary>
        /// Default Constructor
        /// </summary>
        public TsbBizDAOException()
            : base()
        {
        ...
        public TsbBizDAOException(string objectID, string msgCode, params string[] msgArgs)
        ...
        /// <param name="msgCode">A message code to make message</param>
        /// <param name="msgArgs">An array of string to make message</param>
        public TsbBizDAOException(Exception innerException, string sourceObjectID, string msgCode, params string[] msgArgs)
