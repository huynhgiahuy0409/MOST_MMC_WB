...
{
    /// <summary>
    /// TSB Business UI Layer Exception
    /// </summary>
    [Serializable]
    public class TsbBizUIException : TsbBizBaseException
    {
        private readonly string _OBJECT_ID = "GNR-FTCO-EXP-TsbBizUIException";


        /// <summary>
        /// Default Constructor
        /// </summary>
        public TsbBizUIException()
            : base()
        {
        ...
        public TsbBizUIException(string objectID, string msgCode, params string[] msgArgs)
        ...
        /// <param name="msgCode">A message code to make message</param>
        /// <param name="msgArgs">An array of string to make message</param>
        public TsbBizUIException(Exception innerException, string sourceObjectID, string msgCode, params string[] msgArgs)
