...
* 2012.08.30    Jindols 1.0	First release.
* 
*/
#endregion
...
namespace Tsb.Fontos.Core.Data.IBatis.Batch
{
    ...
    /// </summary>
    internal class OracleStaticBatchHandler : SqlBaseBatchHandler, IDisposable
    {
        #region FIELD AREA*****************************
        #endregion
        ...
        /// Initialize Instance
        /// </summary>
        public OracleStaticBatchHandler(ISqlMapper mapper, string statementName, object[] parameterDataObjects)
        ...
        public override int ExecuteBatch()
        {
            ...
            try
            {
                ...
                List<object[]> parameterBatchDataArray = this.ConvertToBatchData(this.ParameterDataObjects);
                ...
                returnValue = request.IDbCommand.ExecuteNonQuery();
            }
        ...
        private List<object[]> ConvertToBatchData(object[] parameterDataObjects)
        {
