...
{
    public class LowerCreditValidator : BasePasswordValidator
    {
        #region READONLY AREA **********************************
        /// <summary>
        /// Password Regx
        /// </summary>
        private readonly string PASSWORD_REGX = @"(?=(?:.*?[a-z]){" + SecurityPolicyInfo.GetInstance().LowerCredit + "})";
        #endregion
        ...
        public SecurityPolicyInfo.PasswordValidationResultTypes ValidatorType 
        {
            get
            {
                return SecurityPolicyInfo.PasswordValidationResultTypes.LOWER;
            }
        }
        #endregion
        ...
        /// Default Constructor
        /// </summary>
        public LowerCreditValidator()
            : base()
        {
            this.ObjectID = "GNR-FTCO-VAL-LowerCreditValidator";
        ...
        public override List<ValidResultItem> Validate(ref List<ValidResultItem> resultList)
        {
            ...
            {
                //MSG:Lowercase letters (a - z) should be more than {0}.
                resultList = this.HandleResult(ref resultList, ResultType.ERROR, "MSG_FTCO_00188", DefaultMessage.NON_REG_WRD + SecurityPolicyInfo.GetInstance().LowerCredit);
            }
            else
            {
