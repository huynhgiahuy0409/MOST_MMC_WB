...
{
    public class YtListSingleTwinController : BaseMobileBizController
    {
        #region CONST & FIELD AREA ********************************************

        private readonly string OBJECT_ID = "CTL-CT-CTMO-CTRL-YtListSingleTwinController";
        private readonly string NONE_YT = "[NONE]";
        private YtListSingleTwinInterface _formView;
        private BaseItemsList<EquipmentItem> _ytList = null;
        public readonly string JOB_TYPE_NONE = "N";
        public readonly string JOB_TYPE_SINGLE = "S";
        public readonly string JOB_TYPE_TWIN = "T";
        ...
        public string SelectedSingleTwin { get; set; }
        ...
        public YtListSingleTwinController()
        {
            ObjectID = OBJECT_ID;
        }

        public YtListSingleTwinController(YtListSingleTwinInterface view)
        {
            ObjectID = OBJECT_ID;
            _formView = view;
        }
        ...
        public void DoRetrieveData()
        {
            ...
            try
            {
                ...
                BaseItemsList<ItemListControlItem> singleTwinItemList = new BaseItemsList<ItemListControlItem>();
                ItemListControlItem noneItem = new ItemListControlItem();
                noneItem.Code = JOB_TYPE_NONE;
                noneItem.CodeName = "None";
                noneItem.TextValue = ResourceFactory.GetResource().GetLabel("WRD_CTYQ_Preserve");
                singleTwinItemList.Add(noneItem);

                if (this.TEU == 1)
                {
                    ItemListControlItem singleTwinItem = new ItemListControlItem();
                    singleTwinItem.Code = JOB_TYPE_SINGLE;
                    singleTwinItem.CodeName = "Single";
                    singleTwinItem.TextValue = ResourceFactory.GetResource().GetLabel("WRD_CTYQ_Single");
                    singleTwinItemList.Add(singleTwinItem);

                    ItemListControlItem singleTwinItem2 = new ItemListControlItem();
                    singleTwinItem2.Code = JOB_TYPE_TWIN;
                    singleTwinItem2.CodeName = "Twin_Combi";
                    singleTwinItem2.TextValue = ResourceFactory.GetResource().GetLabel("WRD_CTYQ_Twin_Combo");
                    singleTwinItemList.Add(singleTwinItem2);
                }

                _formView.SetSingleTwinItemList(singleTwinItemList);
                //_formView.SetSingleTwinItem("");
            }
