...
{
    public interface ITruckListPopupDao
    {
        #region SEARCH AREA *****************************************
        /// <summary>
        /// Inquire the SingleGrid's table with the specified item.
        /// </summary>
        /// <param name="item">TruckListPopupDao</param>
        /// <returns>the rows inquired</returns>
        //BaseItemsList<TruckListPopupItem> InquiryLorryList(TruckListPopupParam param); WeightInfoItem
        BaseItemsList<WeightInfoItem> InquiryLorryList(TruckListPopupParam param);
        #endregion
