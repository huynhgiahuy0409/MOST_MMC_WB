...
using Tsb.Fontos.Tp.Common.ServiceSpec;
using Tsb.Fontos.Tp.Service.Sample;
...
namespace Tsb.Product.WB.Client.Sample
{
    public class SingleGridController : BaseSingleGridController
    {
        ...
        /// </summary>
        public static readonly string SYNC_NOTIFY_NAME = "SYNC-FT-FTTP-SPL-SingleGrid";
        #endregion
        ...
        public SingleGridController()
            : base()
        {
            this.ObjectID = "CTL-FT-FTTP-SPL-SingleGridController";
        }
        ...
        public BaseResult DoRetrieveData()
        {
            ...
            try
            {
                ...
                param.TransactionInfo.TxServiceID = FontosTpServiceSpec.SAMPLE_SINGLE_GRID_SERVICE;
        ...
        public void DoSaveData()
        {
            ...
            param = new SingleGridParam(this, FontosTpServiceSpec.SAMPLE_SINGLE_GRID_SERVICE);
        ...
        public void DoDeleteData(object sender, GridRowRemovedEventArgs e)
        {
            ...
            SingleGridParam param = new SingleGridParam(this, FontosTpServiceSpec.SAMPLE_SINGLE_GRID_SERVICE);
            this.service = BizServiceLocator.GetService<ISingleGridService>(param);
